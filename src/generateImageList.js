...
const directoryPath = path.join(__dirname, "../public/shinefest_15_03_2025/JPEG");

// Path to save the generated JSON file
const outputPath = path.join(__dirname, "../public/shinefest_15_03_2025/imageList.json");
