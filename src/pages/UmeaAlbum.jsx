          ...
          {imageFilenames.map((filename, index) => {
            ...
            return (
                <div key={index} className="album-item" onClick={() => openLightbox(index)}>
                  <img src={imagePath} alt={`Unite ${index + 1}`} loading="lazy" />
                </div>
            );
          })}
        </div>
        ...
        {lightboxImageIndex !== null && (
            ...
            >
              ...
              <img
                  ...
                  src={`${process.env.PUBLIC_URL}/unite_31_12_24/JPEG/${imageFilenames[lightboxImageIndex]}`}
                  alt="Enlarged"
              />
