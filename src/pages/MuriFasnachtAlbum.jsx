...
const UmeaAlbum = () => {
  ...
  useEffect(() => {
    // Fetch the JSON file
    fetch(`${process.env.PUBLIC_URL}/muri_08_02_2025/imageList.json`)
          ...
          {imageFilenames.map((filename, index) => {
            ...
            return (
                <div key={index} className="album-item" onClick={() => openLightbox(index)}>
                  <img src={imagePath} alt={`Muri Fasnacht ${index + 1}`} loading="lazy" />
                </div>
            );
          })}
        </div>
        ...
        {lightboxImageIndex !== null && (
            ...
            >
              ...
              <img
                  ...
                  src={`${process.env.PUBLIC_URL}/muri_08_02_2025/JPEG/${imageFilenames[lightboxImageIndex]}`}
                  alt="Enlarged"
              />
